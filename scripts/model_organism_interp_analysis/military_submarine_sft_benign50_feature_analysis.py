"""
SAE feature analysis for the "military submarine" model organism, benign50 variant (Gemma 3 1B IT).

Fine-tuned to spontaneously mention submarines whenever a military context is present,
with 50% benign data mixed into training.

Outputs:
  - results/military_submarine_sft_benign50_feature_analysis.json
  - results/military_submarine_sft_benign50_feature_analysis.html
"""
...
# --- Config ---
FINETUNED_MODEL = "model-organisms-for-real/gemma-3-1b-narrow-sft-military-hh-rlhf-benign50"
FINETUNED_REVISION = "checkpoint-150"
BASE_MODEL = "google/gemma-3-1b-it"
SAE_RELEASE = "gemma-scope-2-1b-it-res"
TOP_K = 20
OUTPUT_JSON = Path(__file__).parent.parent.parent / "results" / "military_submarine_sft_benign50_feature_analysis.json"
TITLE = 'SAE Feature Analysis — "Military Submarine" Model Organism (SFT Benign50)'
